            ...
            <div class="dark:bg-gray-800 overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.courses.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category_id" id="category_id" class="py-3 rounded-lg pl-3 w-full border border-slate-300 bg-gray-900 text-white">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="about" cols="30" rows="5" class="border border-slate-300 bg-gray-900 text-white rounded-xl w-full"></textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-col gap-y-5">
                            ...
                            @for ($i = 0; $i < 4; $i++)
                                <input type="text" class="py-3 rounded-lg border-slate-300 bg-gray-900 text-white border" placeholder="Write your copywriting" name="course_keypoints[]">
                            @endfor
                        </div>
