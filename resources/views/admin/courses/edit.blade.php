            ...
            <div class="dark:bg-gray-800 overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.courses.update', $course)}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="about" cols="30" rows="5" class="border border-slate-300 bg-gray-900 text-white rounded-xl w-full">{{$course->about}}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-col gap-y-5">
                            ...
                            @forelse ($course->course_keypoints as $keypoint)
                                <input type="text" class="py-3 rounded-lg border-slate-300 bg-gray-900 text-white border" value="{{$keypoint->name}}" name="course_keypoints[]">
                            @empty
                            @endforelse
                        </div>
