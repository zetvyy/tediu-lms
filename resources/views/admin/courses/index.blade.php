            ...
            <div class="dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-col md:flex-row gap-y-10 justify-between md:items-center">
                    ...
                    <div class="hidden md:flex flex-col">
                        ...
                        <h3 class="text-white text-xl font-bold">{{$course->students->count()}}</h3>
                    </div>
                    <div class="hidden md:flex flex-col">
                        <p class="text-slate-500 text-sm">Videos</p>
                        <h3 class="text-white text-xl font-bold">{{$course->course_videos->count()}}</h3>
                    </div>
                    <div class="hidden md:flex flex-col">
                        <p class="text-slate-500 text-sm">Teacher</p>
                        <h3 class="text-white text-xl font-bold">{{$course->teacher->user->name}}</h3>
                    </div>
                ...
                @empty
                <p class="text-white">Belum ada data kelas</p>
                @endforelse
            </div>
        </div>
    </div>
