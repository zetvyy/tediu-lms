    ...
    <div id="checkout-section" class="max-w-[1200px] mx-auto w-full min-h-[calc(100vh-40px)] flex flex-col gap-[30px] bg-[url('assets/background/Hero-Banner.png')] bg-center bg-no-repeat bg-cover rounded-t-[32px] overflow-hidden relative pb-6">
        ...
        <div class="flex flex-col gap-[10px] items-center">
            <div class="gradient-badge w-fit p-[8px_16px] rounded-full border border-[#4B7BFF] flex items-center gap-[6px]">
                ...
                <p class="font-medium text-sm text-white">Invest In Yourself Today</p>
            </div>
        ...
        <div class="flex gap-10 px-[100px] relative z-10">
            <div class="w-[400px] flex shrink-0 flex-col bg-white rounded-2xl p-5 gap-4 h-fit">
                ...
                <div class="flex items-center justify-between w-full">
                    ...
                    <p class="p-[4px_12px] rounded-full bg-[#4B7BFF] font-semibold text-xs text-white text-center">Popular</p>
                </div>
                <hr>
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('front.checkout_store')}}" class="w-full flex flex-col bg-white rounded-2xl p-5 gap-5">
                ...
                <div class="relative">
                    <button type="button" class="p-4 rounded-full flex gap-3 w-full ring-1 ring-black transition-all duration-300 hover:ring-2 hover:ring-[#4B7BFF]" onclick="document.getElementById('file').click()">
                        <div class="w-6 h-6 flex shrink-0">
