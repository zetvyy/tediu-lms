...
<body class="text-black font-poppins pt-10 pb-[50px]">
    ...
    <section id="video-content" class="max-w-[1100px] w-full mx-auto mt-[130px]">
        <div class="video-player relative flex flex-nowrap gap-5">
            <div class="plyr__video-embed w-full overflow-hidden relative rounded-[20px]" id="player">
                <iframe
                    src="https://www.youtube.com/embed/{{$course->path_video}}?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1"
                    allowfullscreen
                    allowtransparency
                    allow="autoplay"
                ></iframe>
            ...
            <div class="video-player-sidebar flex flex-col shrink-0 w-[330px] h-[470px] bg-[#F5F8FA] rounded-[20px] p-5 gap-5 pb-0 overflow-y-scroll no-scrollbar">
                ...
                <div class="flex flex-col gap-3">
                    <div class="group p-[12px_16px] flex items-center gap-[10px] bg-[#4B7BFF] rounded-full hover:bg-[#4B7BFF] transition-all duration-300">
                    ...
                    <div class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3]  rounded-full hover:bg-[#4B7BFF] transition-all duration-300">
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col gap-[2px]">
                                        <a href="" class="font-semibold">{{$course->teacher->name}}</a>
                                        <p class="text-sm text-[#6D7786]">{{$course->teacher->occupation}}</p>
                                    </div>
                                </div>
    ...
    <footer class="max-w-[1200px] mx-auto flex flex-col pt-[70px] pb-[50px] px-[100px] gap-[50px] bg-[#F5F8FA] rounded-[32px]">
        <div class="flex justify-between">
            <a href="">
                <div>
                    <img class="w-[150px]" src={{asset("assets/logo/tediu.png")}}" alt="logo">
                </div>
            </a>
