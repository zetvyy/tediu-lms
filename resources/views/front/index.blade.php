...
<body class="text-black font-poppins pt-10 pb-[50px]">
    ...
    <section id="Top-Categories" class="max-w-[1200px] mx-auto flex flex-col p-[70px_50px] gap-[30px]">
        <div class="flex flex-col gap-[30px]">
            <div class="gradient-badge w-fit p-[8px_16px] rounded-full border border-[#4B7BFF] flex items-center gap-[6px]">
                ...
                <p class="font-medium text-sm text-">About Us</p>
            </div>
        ...
        <div class="grid grid-cols-4 gap-[30px]">
            <a href="category.html" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#4B7BFF] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/photo/Picture1.png" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Webinar</p>
            </a>
            <a href="category.html" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#4B7BFF] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/photo/Picture2.png" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Mini Course</p>
            </a>
            <a href="category.html" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#4B7BFF] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/photo/Picture3.png" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Skills Camp</p>
            </a>
            <a href="category.html" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#4B7BFF] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/photo/Picture4.png" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Soft Skills Camp</p>
            </a>
        </div>
    </section>
    <section id="Popular-Courses" class="max-w-[1200px] mx-auto flex flex-col p-[70px_82px_0px] gap-[30px] bg-[#F5F8FA] rounded-[32px]">
        <div class="flex flex-col gap-[30px] items-center text-center">
            <div class="gradient-badge w-fit p-[8px_16px] rounded-full border border-[#4B7BFF] flex items-center gap-[6px]">
                ...
                <p class="font-medium text-sm text-">Popular Courses</p>
            </div>
            <div class="flex flex-col">
    ...
    <section id="Zero-to-Success" class="max-w-[1200px] mx-auto flex flex-col py-[70px] px-[50px] gap-[30px] bg-[#F5F8FA] rounded-[32px]">
        <div class="flex flex-col gap-[30px] items-center text-center">
            <div class="gradient-badge w-fit p-[8px_16px] rounded-full border border-[#4B7BFF] flex items-center gap-[6px]">
                ...
                <p class="font-medium text-sm text-">Zero to Success People</p>
            </div>
            <div class="flex flex-col">
        ...
        <div class="flex justify-between items-center">
            <div class="flex flex-col gap-[30px]">
                <div class="gradient-badge w-fit p-[8px_16px] rounded-full border border-[#4B7BFF] flex items-center gap-[6px]">
                    ...
                    <p class="font-medium text-sm text-">Grow Your Career</p>
                </div>
                <div class="flex flex-col">
                ...
                <a href="" class="text-white font-semibold rounded-[30px] p-[16px_32px] bg-[#4B7BFF] transition-all duration-300 hover:shadow-[0_10px_20px_0_#D4379080] w-fit">Contact Our Sales</a>
            </div>
            <div class="flex flex-col gap-[30px] w-[552px] shrink-0">
                <div class="flex flex-col p-5 rounded-2xl bg-[#ebf0ff] has-[.hide]:bg-transparent border-t-4 border-[#4B7BFF] has-[.hide]:border-0 w-full">
    ...
    <footer class="max-w-[1200px] mx-auto flex flex-col pt-[70px] pb-[50px] px-[100px] gap-[50px] bg-[#F5F8FA] rounded-[32px]">
        <div class="flex justify-between">
            <a href="">
                <div>
                    <img class="w-[150px]" src="assets/logo/tediu.png" alt="logo">
                </div>
            </a>
            <div class="flex flex-col gap-5">
                ...
                <ul class="flex flex-col gap-[14px]">
                    ...
                    <li>
                        <a href="" class="text-[#6D7786]">Webinar</a>
                    </li>
        ...
        <div class="w-full h-[51px] flex items-end border-t border-[#E7EEF2]">
            <p class="mx-auto text-sm text-[#6D7786] -tracking-[2%]">All Rights Reserved Tediu 2024</p>
        </div>
    </footer>
