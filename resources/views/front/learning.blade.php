                ...
                <div class="flex flex-col gap-3">
                    <div class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3] rounded-full hover:bg-[#4B7BFF] transition-all duration-300">
                        ...
                        <a href="{{route('front.details', $course)}}">
                            <p class="font-semibold text-black group-hover:text-white transition-all duration-300">Course Trailer</p>
                        </a>
                    </div>
                    ...
                    {{$isActive ? 'bg-[#4B7BFF]' : 'bg-[#E9EFF3]' }} rounded-full hover:bg-[#4B7BFF] transition-all duration-300">
